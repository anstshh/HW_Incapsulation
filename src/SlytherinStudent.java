public class SlytherinStudent extends HogwartsStudent{
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Слизеринец %s лучше, чем слизеринец %s: %s VS %d%n", getName(), slytherinStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("Слизеринец %s лучше, чем Слизеринец %s: %s VS %d%n", slytherinStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Слизеринец %s такой же, как слизеринец %s: %s VS %d%n", slytherinStudent.getName(), getName(), ability1, ability2);
        }
    }
