public class RavenclawStudent extends HogwartsStudent {
    ...
    public void compareRavenclaw(RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Когтевранец %s лучше, чем когтевранец %s: %s VS %d%n", getName(), ravenclawStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("Когтеранец %s лучше, чем когтевранец %s: %s VS %d%n", ravenclawStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Когтевранец %s такой же, как когтевранец %s: %s VS %d%n", ravenclawStudent.getName(), getName(), ability1, ability2);
        }
    }
